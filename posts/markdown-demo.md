...
```ts title='files/hello.ts'
const a = 1; // this code block has a file name
```
...
2. Initialize a package manager.
...
For more information, read the [TypeScript documentation](https://www.example.com).
...
![A placeholder image](https://placehold.co/400)
<figcaption>
    Placeholder caption.
